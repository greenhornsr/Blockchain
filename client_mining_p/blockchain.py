...
​
    ...
    def valid_proof(block_string, proof):
        ...
        # return even occurs when the hash starts with 00000 (five zeros).  the lower the number, the faster the success return event, the higher the number, the longer it takes!
